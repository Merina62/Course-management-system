...
public class Course extends JFrame {
	...
	public Course() {
		...
		btnedit.setBounds(754, 84, 64, 32);
		...
		btndelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                DeleteCourse deleteCourseFrame = new DeleteCourse();
		...
		btndelete.setBounds(828, 84, 64, 32);
